# Django settings for lukuleledotcom project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('luke', 'lukulele@mit.edu'),
)
...
SECRET_KEY = '!k%bpq4ao+r$*e=go3_zm!y2*lz@^eh*%r9#69o(7&amp;!a#sx+p7'
...
ROOT_URLCONF = 'lukuleledotcom.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'lukuleledotcom.wsgi.application'
